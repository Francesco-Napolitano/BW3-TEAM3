...
const HorizontalProfileCard = ({
  ...
  const [formData, setFormData] = useState({ // Dati form modifica profilo
    nome: name || '',
    bio: title || '',
    posizione: area || '',
  })
          ...
          <div className="profile-info mb-4 d-flex flex-column align-items-start">
            <div className="d-flex justify-content-between w-100">
              <div className="profile-details">
                ...
                <p className="text-muted mb-1 text-start" style={{ fontSize: '1.1rem' }}>
                  {informazioni}
                </p>
                <div className="d-flex align-items-center gap-2 text-muted mb-2">
                  <span style={{ fontSize: '0.95rem' }}>{area}</span>
                  <span>·</span>
                  <span className="text-primary cursor-pointer" style={{ fontSize: '0.95rem' }}>
