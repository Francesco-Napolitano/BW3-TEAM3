  ...
  return (
    <Container fluid>
      <Row className="row-cols-1 g-4">
        ...
        <Col className=" bg-white rounded-4 shadow-sm p-0">
          <div className="d-flex flex-column align-items-start text-start position-relative">
            ...
            <div
              ...
              style={{ marginTop: '-6rem', marginLeft: '24px' }}
            >
              <img
                src={
                  profile.image ||
            ...
            <div className="mt-3 ms-4">
              ...
              <p className="text-muted">
                {Math.floor(Math.random() * 500) + 100} collegamenti
              </p>
            </div>
          </div>
        </Col>
        ...
        <Col className="p-4 bg-white rounded-4 shadow-sm">
          <div className="d-flex flex-column align-items-start text-start">
            <h2>Informazioni</h2>
            <p className="m-0">
              Ciao! Mi chiamo <span className="fst-italic">{profile.name}</span>
              , sono{' '}
              <span className="fst-italic">
                {profile.title === '' ? 'Web Developer' : profile.title}{' '}
              </span>
              e vivo a <span className="fst-italic">{' ' + profile.area} </span>
              . La mia carriera è iniziata come freelancer, e oggi sono
              orgoglioso di collaborare con clienti e team per sviluppare
              soluzioni web end-to-end.
              <br /> <br />
              Se vuoi metterti in contatto con me, scrivimi pure a{' '}
              <span className="fst-italic">{profile.email}</span> o connettiti
              su LinkedIn per discutere di nuove opportunità o collaborazioni!
            </p>
          </div>
        </Col>
        ...
        <Col className="p-4 bg-white rounded-4 shadow-sm">
          <Row className="text-start">
            ...
            <Col xs={12} lg={4}>
              ...
              <span className="">
                {profileStats?.visits || 0} collegamenti al profilo
              </span>
            </Col>
            <Col xs={12} lg={4}>
              <i className="bi bi-bar-chart-fill me-3 fs-3"></i>
              <span className="">
                {profileStats?.impressions || 0} impressioni del post
              </span>
            </Col>
            <Col xs={12} lg={4}>
              <i className="bi bi-search me-3 fs-3"></i>
              <span className="">
                {profileStats?.searches || 0} ricerche del profilo
              </span>
            </Col>
          </Row>
        </Col>
